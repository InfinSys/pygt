...
WINDOW_IS_X_RESIZABLE: str = "window_is_x_resizable"  # NEW
WINDOW_IS_Y_RESIZABLE: str = "window_is_y_resizable"  # NEW
WINDOW_IS_MINIMIZED: str = "window_is_minimized"
WINDOW_IS_FULLSCREEN: str = "window_is_fullscreen"
WINDOW_IS_ALWAYS_TOPMOST: str = "window_is_topmost"  # NEW
...
SET_WINDOW_RESIZABILITY: str = "set_window_resizability"  # NEW
TOGGLE_WINDOW_RESIZABILITY: str = "toggle_window_resizable"  # NEW
CENTER_WINDOW: str = "center_window"
WINDOW_TO_DISPLAY: str = "window_to_display"
ENABLE_ALWAYS_TOPMOST_WINDOW: str = "enable_window_topmost"  # NEW
DISABLE_ALWAYS_TOPMOST_WINDOW: str = "disable_window_topmost"  # NEW
WINDOW_TO_FOREGROUND: str = "window_to_foreground"  # NEW
WINDOW_TO_BACKGROUND: str = "window_to_background"  # NEW
