...
def __build_live_controller_test_commands(instance: Window) -> None:
    ...
    cmd_delay = __add_lctc(func=lambda: instance.view.disable_window_view(), delay=cmd_delay)
    ...
    cmd_delay = __add_lctc(func=lambda: instance.view.enable_window_view(), delay=cmd_delay)
